...
QVariantList MainWindow::forex(){
    ...
    doc=QJsonDocument::fromJson(symbol2.Get_Reply("x-rapidapi-key","91c969a8e9msh8b47ffbad7457eep11a88ajsnc07f9fe9120e"));
    obj=doc.object();
    list.append(obj.value("price"));
    ...
    doc=QJsonDocument::fromJson(symbol3.Get_Reply("x-rapidapi-key","91c969a8e9msh8b47ffbad7457eep11a88ajsnc07f9fe9120e"));
    obj=doc.object();
    list.append(obj.value("price"));
