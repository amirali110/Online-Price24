...
QVariantList MainWindow::forex(){
    ...
    doc=QJsonDocument::fromJson(symbol5.Get_Reply("x-rapidapi-key",api_key));
    obj=doc.object();
    list.append(obj.value("price"));
    ...
    doc=QJsonDocument::fromJson(symbol6.Get_Reply("x-rapidapi-key",api_key));
    obj=doc.object();
    list.append(obj.value("price"));
    ...
    doc=QJsonDocument::fromJson(symbol7.Get_Reply("x-rapidapi-key",api_key));
    obj=doc.object();
    list.append(obj.value("price"));
    ...
    doc=QJsonDocument::fromJson(symbol8.Get_Reply("x-rapidapi-key",api_key));
    obj=doc.object();
    list.append(obj.value("price"));
